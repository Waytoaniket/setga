...
src_base = cv.imread("sample_image2.jpeg")
src_test1 = cv.imread("encrypted_text_image.png")
src_test2 = cv.imread("tmp_images/encoded_rotate.jpeg")
src_test3 = cv.imread("tmp_images/encoded_flip.jpeg")
